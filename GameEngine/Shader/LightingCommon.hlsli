...
//
inline int HasDiffuseMap(int textureConfig)
{
    return ((textureConfig & 1) > 0 ? 1 : 0);
}
inline int HasNormalMap(int textureConfig)
{
    return ((textureConfig & 2) > 0 ? 1 : 0);
}
inline int HasSpecularMap(int textureConfig)
{
    return ((textureConfig & 4) > 0 ? 1 : 0);
}
inline int HasAlphaMask(int textureConfig)
{
    return ((textureConfig & 8) > 0 ? 1 : 0);
}
inline int HasRoughnessMap(int textureConfig)
{
...
inline int HasHeightMap(int textureConfig)
{
    return ((textureConfig & 64) > 0 ? 1 : 0);
}
inline int HasEmissiveMap(int textureConfig)
{
